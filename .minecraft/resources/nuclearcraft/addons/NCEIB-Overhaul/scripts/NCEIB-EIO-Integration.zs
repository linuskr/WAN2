...
AlloySmelter.addRecipe(<contenttweaker:thermoconductingblock>*2, [<contenttweaker:extremeblock>, <ore:gemBoronArsenide>*9], 72000);
...
AlloySmelter.addRecipe(<contenttweaker:limno2block>*2, [<ore:blockLithium>, <nuclearcraft:ingot_block:15>], 48000);
