...
// this code changes the default NCO recipes for LECf-251/HECf-251, so as to seamlessly bridge into this add-on
...
for i,array in dFuels{
	mods.nuclearcraft.FuelReprocessor.removeRecipeWithOutput(dIso[i][0][0],dIso[i][0][0],graphite * 3,dIso[i][0][0],dIso[i][0][0],<nuclearcraft:alloy:13>);
	mods.nuclearcraft.FuelReprocessor.removeRecipeWithOutput(dIso[i][1][0],dIso[i][1][0],null,dIso[i][1][0],dIso[i][1][0],null);
	mods.nuclearcraft.FuelReprocessor.removeRecipeWithOutput(dIso[i][2][0],dIso[i][2][0],null,dIso[i][2][0],dIso[i][2][0],null);
	mods.nuclearcraft.FuelReprocessor.removeRecipeWithOutput(dIso[i][3][0],dIso[i][3][0],zirconium,dIso[i][3][0],dIso[i][3][0],null);
	//triso
...
for i,array in dFuels{
	mods.nuclearcraft.FuelReprocessor.removeRecipeWithOutput(dIso[i][0][0],dIso[i][0][0],graphite * 4,dIso[i][0][0],dIso[i][0][1],<nuclearcraft:alloy:13>);
	mods.nuclearcraft.FuelReprocessor.removeRecipeWithOutput(dIso[i][1][0],dIso[i][1][0],null,dIso[i][1][0],dIso[i][1][1],null);
	mods.nuclearcraft.FuelReprocessor.removeRecipeWithOutput(dIso[i][2][0],dIso[i][2][0],null,dIso[i][2][0],dIso[i][2][1],null);
	mods.nuclearcraft.FuelReprocessor.removeRecipeWithOutput(dIso[i][3][0],dIso[i][3][0],zirconium * 2,dIso[i][3][1],dIso[i][3][0],null);
	//triso
